...
Screen {
	id: toonTempScreen1
	property variant dataValues : app.tempDATA[0]
	
	Component.onCompleted: {
		app.temperaturesUpdated1.connect(updateScreen);
	}

	function updateScreen() {
		todaybarGraph.dataValues = app.tempDATA[0]
	}
