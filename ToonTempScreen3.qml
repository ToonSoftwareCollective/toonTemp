...
Screen {
	id: toonTempScreen1
	property variant dataValues : app.tempDATA[2]
	
	Component.onCompleted: {
		app.temperaturesUpdated3.connect(updateScreen);
	}

	function updateScreen() {
		todaybarGraph.dataValues = app.tempDATA[2]
	}
