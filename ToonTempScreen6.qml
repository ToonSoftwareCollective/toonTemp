...
Screen {
	...
	property variant dataValues : app.tempDATA[5]
	
	Component.onCompleted: {
		app.temperaturesUpdated6.connect(updateScreen);
	}

	function updateScreen() {
		todaybarGraph.dataValues = app.tempDATA[5]
	}
