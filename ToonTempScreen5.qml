...
Screen {
	...
	property variant dataValues : app.tempDATA[4]
	
	Component.onCompleted: {
		app.temperaturesUpdated5.connect(updateScreen);
	}

	function updateScreen() {
		todaybarGraph.dataValues = app.tempDATA[4]
	}
