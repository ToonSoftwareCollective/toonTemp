...
Screen {
	id: toonTempScreen1
		property variant dataValues : app.tempDATA[1]
	
	Component.onCompleted: {
		app.temperaturesUpdated2.connect(updateScreen);
	}

	function updateScreen() {
		todaybarGraph.dataValues = app.tempDATA[1]
	}
